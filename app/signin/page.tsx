...
//   return (
//     <div className="max-h-screen flex items-center justify-center py-25 px-4">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* <div className="space-y-3">
              <Button
                ...
                type="button"
                onClick={() => signIn("google", { callbackUrl: "/home" })}
                className="w-full flex items-center justify-center gap-3 py-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800"
              >
